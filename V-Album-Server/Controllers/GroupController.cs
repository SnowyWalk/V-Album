...
[ApiController]
[Route("api/group")]
public class GroupController(GroupService groupService, CreatePostUseCase createPostUseCase, GetFeedUseCase getFeedUseCase, GetAllFeedUseCase getAllFeedUseCase) : ControllerBase
{
