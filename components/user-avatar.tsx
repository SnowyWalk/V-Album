...
export default function UserAvatar({userUuid, showUuid = false}: UserAvatarProps) {
        ...
        return (
            <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                    ...
                    {showUuid && <Skeleton className="h-4 w-32"/>}
                </div>
            </div>
        )
    }
        ...
        return (
            <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                    ...
                    {showUuid && <span className="truncate text-xs">정보 조회 실패</span>}
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
            ...
            <div className="grid flex-1 text-left text-sm leading-tight">
                ...
                {showUuid && <span className="truncate text-xs">{data.userUuid}</span>}
            </div>
        </div>
    )
}