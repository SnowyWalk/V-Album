...
export default function PostEditorDialog({
    ...
    const moveSelectedPhotoFocus = (direction: -1 | 1) => {
        if (selectedIndex < 0) {
            return;
        }
                ...
                <div className="grid min-h-0 min-w-0 flex-1 gap-0 overflow-hidden bg-background xl:grid-cols-[minmax(0,1fr)_420px] 2xl:grid-cols-[minmax(0,1fr)_440px]">
                    ...
                    >
                        <div
                            ...
                            tabIndex={0}
                            className={cn(
                                "relative mx-auto flex aspect-video w-full max-w-[640px] flex-none items-center justify-center overflow-hidden rounded-2xl border border-dashed",
