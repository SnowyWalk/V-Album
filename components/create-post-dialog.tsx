...
export function CreatePostDialog({groupUuid}: { groupUuid: string }) {
    ...
    if (!mounted) {
        return (
            <Button
                className="fixed bottom-8 right-8 h-14 w-14 rounded-full shadow-lg transition-none! duration-0! active:scale-95 z-40 transform-none">
                ...
                <DialogContent className="sm:max-w-[500px]">
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleSubmit}
                                disabled={(!content && selectedImages.length === 0) || isUploading}>
                            {isUploading ? (
                                <>
