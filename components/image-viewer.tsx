    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange} modal={false}>
            ...
            >
                ...
                {/* Main Viewport */}
                <div
                    className="relative flex-1 w-full min-h-0 bg-transparent overflow-hidden flex items-center justify-center select-none">
                    <Carousel
                        setApi={setApi}
                    ...
                    {showMetadata && (
                        <div
                            className="absolute bottom-24 left-1/2 -translate-x-1/2 w-full max-w-md bg-background/60 backdrop-blur-md p-4 rounded-lg border border-border mx-4 z-50 group/metadata">
                            <Button
                                variant="ghost"
                                size="icon"
                            ...
                            <span className="text-xs text-muted-foreground">
                              ({currentPhoto.metadata.latitude.toFixed(4)}, {currentPhoto.metadata.longitude.toFixed(4)})
                                                        ...
                                                        <CopyButton
                                                            text={`${currentPhoto.metadata.latitude}, ${currentPhoto.metadata.longitude}`}/>
                                                    </div>
                                                )}
                                            </div>
                                        )}
                              ...
                              <span className="bg-muted px-2 py-0.5 rounded-full text-xs flex items-center gap-1">
                                {person}
                                  ...
                                  {copiedText === person ? (
                                    ...
                                    <div
                                        className="flex flex-col items-center justify-center py-4 text-muted-foreground gap-2">
                ...
                {/* Footer - 썸네일 리스트 */}
                <div
                    className="h-24 bg-background/40 backdrop-blur-sm border-t border-border flex items-center shrink-0 overflow-hidden select-none">
                    <div
                        ref={scrollRef}
